...
<body>
  ...
  <h1 class="inner-heading">Add Student to Subject</h1>
  <main>
    <div class="tables">
      ...
      <a href="humss.php"><button style=" margin-left: 2%; font-size: 10px; font-family: 'Public Sans', sans-serif;padding: 5px 10px; border-radius: 30px; background-color: #f4f4f4;">HUMSS</button></a> <br>
  ...
  <table id = "table" class = "table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="addtosubject_insert.php?account_id=<?php echo $f_query['account_id']?>"><button>Add Student</button></a></td>
            </tr>
            <?php
              }
            ?>
