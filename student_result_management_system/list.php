...
<body>
    ...
    <div class="button">
    	...
    	<button type="submit" class="fac-btn">Manage Faculty</button> <br>
    </form>
    <form action="section.php">
    	<button type="submit" class="stdnt-btn">Manage Sections</button>
    </form>
    <form action="subjects.php">
    	<button type="submit" class="stdnt-btn">Manage Subjects</button>
    </form>
    </div>
